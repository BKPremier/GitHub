...
wp_register_script('inview', get_template_directory_uri().'/js/jquery.inview.js', array('jquery'),'');
wp_register_script('themes', get_template_directory_uri().'/js/themes.js', array('jquery'),'');
...
wp_die('There was an error trying to delete your file.', 'essentials');
} // end if/el;se
...
$meta_box = array(
    'id' => 'my-meta-box',
    'title' => __('Career Data', 'essentials'),
    'page' => 'careers',
    'context' => 'normal',
    'priority' => 'high',
    'fields' => array(
		array(
            'name' => __('Text to appear next to print icon.  Leave blank to disable the icon.', 'essentials'),
            'desc' => __('Print This Page.', 'essentials'),
            'id' => 'printicontext',
            'type' => 'text',
            'std' => ""
        ),	
       array(
            'name' => __('Text to appear next to download icon.  If you do not upload a file (see below) this text will not appear', 'essentials'),
            'desc' => __('Download PDF File.', 'essentials'),
            'id' => 'downloadicontext',
            'type' => 'text',
            'std' => ""
        ), 
...
function add_custom_meta_box() {
    add_meta_box(
		'custom_meta_box', // $id
		__('Staff Info', 'essentials', 'essentials'), // $title 
...
$custom_meta_fields = array(
	...
	array(
		'label'	=> __('Social Icon 1 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 1.', 'essentials'),
		'id'	=> $prefix.'textlink',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 1 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 1.', 'essentials'),
		'id'	=> $prefix.'text',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 1', 'essentials'),
		'desc'	=> __('Upload your social media image 1', 'essentials'),
		'id'	=> $prefix.'image',
		'type'	=> 'image'
	),
	array(
		'label'	=> __('Social Icon 2 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 2.', 'essentials'),
		'id'	=> $prefix.'textlink2',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 2 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 2.', 'essentials'),
		'id'	=> $prefix.'text2',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 2', 'essentials'),
		'desc'	=> __('Upload your social media image 2', 'essentials'),
		'id'	=> $prefix.'image2',
		'type'	=> 'image'
	),
	array(
		'label'	=> __('Social Icon 3 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 3.', 'essentials'),
		'id'	=> $prefix.'textlink3',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 3 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 3.', 'essentials'),
		'id'	=> $prefix.'text3',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 3', 'essentials'),
		'desc'	=> __('Upload your social media image 3', 'essentials'),
		'id'	=> $prefix.'image3',
		'type'	=> 'image'
	),
	array(
		'label'	=> __('Social Icon 4 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 4.', 'essentials'),
		'id'	=> $prefix.'textlink4',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 4 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 4.', 'essentials'),
		'id'	=> $prefix.'text4',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 4', 'essentials'),
		'desc'	=> __('Upload your social media image 4', 'essentials'),
		'id'	=> $prefix.'image4',
		'type'	=> 'image'
	),
	array(
		'label'	=> __('Social Icon 5 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 5.', 'essentials'),
		'id'	=> $prefix.'textlink5',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 5 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 5.', 'essentials'),
		'id'	=> $prefix.'text5',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 5', 'essentials'),
		'desc'	=> __('Upload your social media image 5', 'essentials'),
		'id'	=> $prefix.'image5',
		'type'	=> 'image'
	),
	array(
		'label'	=> __('Social Icon 6 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 6.', 'essentials'),
		'id'	=> $prefix.'textlink6',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 6 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 6.', 'essentials'),
		'id'	=> $prefix.'text6',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 6', 'essentials'),
		'desc'	=> __('Upload your social media image 6', 'essentials'),
		'id'	=> $prefix.'image6',
		'type'	=> 'image'
	),
	array(
		'label'	=> __('Social Icon 7 Link', 'essentials'),
		'desc'	=> __('Enter the link you want for the social media icon 7.', 'essentials'),
		'id'	=> $prefix.'textlink7',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Social Icon 7 Image Alt Text', 'essentials'),
		'desc'	=> __('Enter the title text to display for the social media icon 7.', 'essentials'),
		'id'	=> $prefix.'text7',
		'type'	=> 'text'
	),
	array(
		'label'	=> __('Upload the Social Media Image 7', 'essentials'),
		'desc'	=> __('Upload your social media image 7', 'essentials'),
		'id'	=> $prefix.'image7',
		'type'	=> 'image'
	),
	array(
